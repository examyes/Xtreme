...
bool CSyntaxParser::parse_phase_2(CTokenStream& token_stream,
                                  CInstrStream& instr_stream)
{
...
bool CSyntaxParser::phase_2_func(CTokenStream& token_stream,
                                 shared_ptr<SToken>& token_ptr,
                                 CInstrStream& instr_stream)
{
		return true;
...
bool CSyntaxParser::phase_2_param(CTokenStream& token_stream,
                                  shared_ptr<SToken>& token_ptr,
                                  CInstrStream& instr_stream)
{
		return true;
...
bool CSyntaxParser::phase_2_close_brace(CTokenStream& token_stream,
                                        shared_ptr<SToken>& token_ptr,
                                        CInstrStream& instr_stream)
{
		return true;
...
bool CSyntaxParser::phase_2_instruction(CTokenStream& token_stream,
                                        shared_ptr<SToken>& token_ptr,
                                        CInstrStream& instr_stream)
{
		return true;
